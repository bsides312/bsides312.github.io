<script lang="ts">
	// Placeholder for future schedule data
</script>
...
<svelte:head>
	...
	<meta
		name="description"
		content="BSides312 Conference Schedule - Coming May 16th, 2026 in Chicago."
	/>
</svelte:head>
...
<section id="schedule" class="section section-with-bg">
	<div class="container">
		<div class="section-header">
			...
			<p>Schedule for BSides312 2026 coming soon!</p>
		</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="card text-center p-4">
					<div class="card-body">
						<i class="bi bi-calendar-event display-1 text-info mb-4"></i>
						<h3 class="mb-3">Schedule Coming Soon</h3>
						<p class="mb-4">
