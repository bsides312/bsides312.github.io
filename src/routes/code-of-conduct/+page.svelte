		...
		<div class="row justify-content-center">
			<div class="col-lg-9">
				...
				<div class="card mb-4">
					<div class="card-body">
						<h3 class="card-title">
							<i class="bi bi-shield-check text-success me-2"></i>Our Commitment
						</h3>
						<p>
				...
				<div class="card mb-4">
					<div class="card-body">
						<h3 class="card-title">
							<i class="bi bi-person-check text-info me-2"></i>Expected Behavior
						</h3>
				...
				<div class="card mb-4">
					<div class="card-body">
						<h3 class="card-title">
							<i class="bi bi-x-octagon text-danger me-2"></i>Unacceptable Behavior
						</h3>
				...
				<div class="card mb-4">
					<div class="card-body">
						<h3 class="card-title">
							<i class="bi bi-megaphone text-warning me-2"></i>Reporting &amp; Enforcement
						</h3>
				...
				<div class="card mb-4">
					<div class="card-body">
						<h3 class="card-title">
							<i class="bi bi-heart text-danger me-2"></i>Inclusivity Statement
						</h3>
						<p>
