...
Utilizing his 6+ years of accounting experience combined with 28 years of Information Security and Information Technology experience, he speaks regularly with technology executives and professionals to help protect their corporate secrets and stay compliant.`,
		social: {
			twitter: 'https://twitter.com/dschwartzberg',
			facebook: 'https://www.facebook.com/DavidASchwartzberg',
			instagram: 'https://www.instagram.com/healwhans',
			linkedin: 'https://www.linkedin.com/in/davidschwartzberg/'
		}
	},
	{
		id: 'xmas',
		...
		image: '/assets/img/about/jxmas2.jpg',
...
Professionally, Johnny leads Offensive Security for a Fortune 1000/Global 5000 manufacturing and agricultural company, where he continues to drive innovation and strengthen organizational defenses.`,
		social: {
			linkedin: 'https://www.linkedin.com/in/antoniojohnnymartinelli/'
		}
	},
	{
		id: 'wags',
		...
		social: {
			linkedin: 'https://www.linkedin.com/in/robertwagner2/'
		}
	},
	{
		id: 'mkavka',
		name: 'Mike Kavka',
		title: 'Director',
		image: '/assets/img/about/mkavka2.jpg',
		...
		social: {
			linkedin: 'https://www.linkedin.com/in/mbkavka/'
		}
	}
]; 